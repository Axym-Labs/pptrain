...
def _build_smoke_profile(
    *,
    ...
    return ReplicationProfile(
        name="smoke",
        description="Tiny local proxy-study smoke run for pipeline validation.",
    ...
    *,
    ...
    studies = (
        MechanismStudySpec(
            ...
            synthetic_run_config_overrides={
                "max_steps": 72,
                "save_steps": 18,
                "eval_steps": 18,
                "warmup_steps": 4,
    ...
    return ReplicationProfile(
        ...
        arithmetic_probe=ArithmeticProbeConfig(num_examples=32, max_addend=19, max_new_tokens=8),
