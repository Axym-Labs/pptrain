...
| task | Transfer beats baseline | Converges faster | Beats compute-matched baseline | Reasoning transfer | Algorithmic transfer | Preferred synthetic preset | Close to matched baseline |
| --- | --- | --- | --- | --- | --- | --- | --- |
| NCA | ❌ | ➖ | ❌ | ❔ | ➖ | ➖ | ➖ |
| LIME | ❌ | ➖ | ❌ | ❔ | ➖ | ➖ | ➖ |
| Simpler tasks | ❌ | ➖ | ❌ | ➖ | ➖ | ➖ | ➖ |
...
| task | preset | seeds | baseline loss | task-pretrained loss | natural baseline loss | task-pretrained gap % | baseline gap % | convergence delta | reasoning gain | algorithmic gain | task-pretrained KL | task-pretrained CKA | task-pretrained rank | nca synth acc |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
